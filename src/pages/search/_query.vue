<template>
  <section id="search-query" class="section">
    <div id="search-title" class="has-text-centered">
      <p class="title">"{{query}}"</p>
      <p class="subtitle">Search Results</p>
    </div>
    <div class="container">
      <ul>
        <li class="movie-list-single" v-for="movie in movies" :key="movie.imdbID">
